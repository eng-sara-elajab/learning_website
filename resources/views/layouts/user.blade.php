        ...
        <div class="wrapper">
            ...
            <aside class="main-sidebar sidebar-dark-primary elevation-4">
                ...
                <a href="#" class="brand-link">
                    ...
                    @endif
                    <span class="brand-text font-weight-light">{{$website_information->name}}</span>
                </a>
                ...
                <div class="sidebar">
                    ...
                    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                        <div class="image">
                            ...
                            @else
                                <img src="images/profiles/{{Auth::user()->profile_photo}}" class="img-circle elevation-2" alt="User Image">
                            @endif
                        </div>
                        <div class="info">
